...
{ path : 'addmaterial', loadChildren: () => import('./addmaterial/addmaterial.module').then(m => m.AddmaterialModule), canActivate: [AuthGuard] } , 
{ path : 'allmaterial', loadChildren: () => import('./allmaterial/allmaterial.module').then(m => m.AllmaterialModule), canActivate: [AuthGuard] } , 
{ path : 'upatematerial', loadChildren: () => import('./upatematerial/upatematerial.module').then(m => m.UpatematerialModule), canActivate: [AuthGuard] } , 
];
